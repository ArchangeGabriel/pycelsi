...
t0 = time()
animer(0, systeme, 0, calc_per_frame, periode_affichage, temps_relat, dt, wait)
t1 = time()
...
anim = FuncAnimation (fig, animer, fargs=(systeme, T, calc_per_frame, periode_affichage, temps_relat, dt, wait), interval=intervalle, blit=True, init_func=initialisation)
